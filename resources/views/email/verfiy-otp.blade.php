<body style="margin: 0; padding: 0; font-family: Helvetica, Arial, sans-serif; background-color: #fff;">
  <table role="presentation" style="width: 100%; border-collapse: collapse; border: 0; font-family: Arial, Helvetica, sans-serif; background-color: #efefef;">
    <tr>
        ...
        <table role="presentation" style="max-width: 600px; border-collapse: collapse; border: 0; text-align: left;">
          <td style="padding: 40px 0 0; text-align: center;">
            <div style="padding-bottom: 20px;">
              <img src="{{ asset('img/brand-logo.png') }}" alt="EarthLink" style="width: 64px;">
            </div>
            <div style="padding: 20px; background-color: #fff; color: #000; text-align: left;">
              ...
              <p style="padding-bottom: 16px; font-size: 130%"><strong>{{ $reset_token }}</strong></p>
              <p style="padding-bottom: 16px">If you didn't request this, you can ignore this email.</p>
              <p style="padding-bottom: 16px">Thanks,<br>EarthLink</p>
            </div>
