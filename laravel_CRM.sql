...
INSERT INTO `customers` (`id`, `fullname`, `email`, `phone`, `personal_id`, `type`, `status`, `avatar`, `address`, `password`, `reset_token`, `created_at`, `updated_at`) VALUES
(2,	'Paul Jefferson',	'paul@rhraju.com',	'+8801987338945',	1313625,	'personal',	'active',	NULL,	NULL,	'$2y$12$WCXHjHUTMmCDAWx5CmsEXOL5cI9xDHCqTK0vuTuQu2yT9KyOcPh/G',	NULL,	'2024-06-25 19:45:51',	'2024-07-07 13:20:57'),
...
(7,	'Natalie Portman',	'natalie@rhraju.com',	'+8801374883999',	4826604,	'personal',	'inactive',	NULL,	'36 Broadway Avenue, Dhaka -1202',	'$2y$12$yUt1VrMVlQp5ZlRmAC6saOJ.LCpmThsbn6whAlFn0hGdiKnXttUwy',	NULL,	'2024-06-25 19:45:51',	'2024-07-13 09:31:02'),
(8,	'Channing Hendrix',	'hendrix@rhraju.com',	'+8801829558459',	2003621,	'personal',	'active',	NULL,	NULL,	'$2y$12$EQwEs5Gmy0pzIKmG53rEw.pd2ypJJ4vTFRp.n0r3b56R7xSgKqK5u',	NULL,	'2024-06-25 19:45:51',	'2024-07-07 09:06:29'),
(9,	'Pete Murphy',	'pete@rhraju.com',	'+8801928665334',	6005978,	'personal',	'inactive',	NULL,	'365 Broadway R/A, Dhaka - 1202',	'$2y$12$ICoMjr9OFLoOmVLMcdh2Wu7AdGEv0ppHCqmaTPNqUv2E5G37HYJ2q',	NULL,	'2024-06-25 19:45:51',	'2024-07-13 09:31:02'),
...
(12,	'Nadine Tyler',	'xudomu@mailinator.com',	'+8801928366274',	1499994,	'personal',	'inactive',	NULL,	NULL,	'$2y$12$gFVcR8fft0EpiDaHbjdvaes6s5lT8DOveDK/7s.Qxzg2xEG9YcpeK',	NULL,	'2024-03-25 15:21:56',	'2024-07-13 09:31:02'),
(13,	'Lamar Waller',	'suluhopi@mailinator.com',	'+8801675652468',	3032624,	'personal',	'inactive',	NULL,	NULL,	'$2y$12$.BuBeoEwnrtWJOEJ.zBaKuINpxVxecLBLlXE0aLhpDdKN8NtnANXq',	NULL,	'2024-04-25 15:25:27',	'2024-07-13 09:31:02'),
...
(16,	'Salvador Kirkland',	'tocikebybi@mailinator.com',	'+8801748338362',	9703063,	'personal',	'inactive',	NULL,	NULL,	'$2y$12$W7F9hQpY/f.WjpKPJyg7jeSoa268kH8odwHdM8nTR6/M9IvwOH7HK',	NULL,	'2024-05-25 15:25:47',	'2024-07-13 09:31:02'),
(17,	'Mikayla Jennings',	'puzixufa@mailinator.com',	'+8801419571428',	9870993,	'personal',	'inactive',	NULL,	NULL,	'$2y$12$zbzverYRqYXjXSNSC3reW.lQD0Uh96xCkxEwrq/zMY1A4JmGtw8HK',	NULL,	'2024-05-25 15:25:53',	'2024-07-13 09:31:02'),
(19,	'Rafael Middleton',	'rafael@rhraju.com',	'+8801876590342',	2076961,	'personal',	'active',	NULL,	'354 Housing State, Chittagong',	'$2y$12$2.UVxMQLmmHdaC0rwYpHk.w6xOZGJHk2AnZxgxJxIaK7797JrmW9y',	NULL,	'2024-07-13 04:19:51',	'2024-07-13 04:24:01')
ON DUPLICATE KEY UPDATE `id` = VALUES(`id`), `fullname` = VALUES(`fullname`), `email` = VALUES(`email`), `phone` = VALUES(`phone`), `personal_id` = VALUES(`personal_id`), `type` = VALUES(`type`), `status` = VALUES(`status`), `avatar` = VALUES(`avatar`), `address` = VALUES(`address`), `password` = VALUES(`password`), `reset_token` = VALUES(`reset_token`), `created_at` = VALUES(`created_at`), `updated_at` = VALUES(`updated_at`);
...
(12,	'2024_07_05_123253_create_cache_locks_table',	4),
(13,	'2024_07_06_162445_create_cache_table',	5)
...
(5,	9,	'Beside Hillside Hospital, Chawkbazar, Chittagong, Bangladesh-4000',	3,	1050.00,	'cash',	'2024-07-07 06:35:54',	'2024-07-07 06:35:54'),
(6,	7,	'34 Hillside Ave, Chittagong, Bangladesh-4201',	3,	1050.00,	'cash',	'2024-07-07 15:18:58',	'2024-07-07 15:18:58'),
(7,	19,	'365 Housing State, Chittagong, Bangladesh-4000',	2,	850.00,	'cash',	'2024-07-13 04:22:33',	'2024-07-13 04:22:33')
...
('Enz3uMMzn46K3XVPBR8lMT0CQVZ3CQWyO3yQKrzO',	NULL,	'127.0.0.1',	'Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/126.0.0.0 Safari/537.36',	'',	1720883351),
('Vc7gmIfZPKK9IThvtJXMjuQiWMZYY7MZEJ1wZLFE',	NULL,	'127.0.0.1',	'Mozilla/5.0 (X11; Linux x86_64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/126.0.0.0 Safari/537.36',	'',	1720881835)
...
(2,	'Adrien Emerson',	'emerson@rhraju.com',	'+8801879556433',	NULL,	'sales',	35000.00,	'2024-05-18 13:11:43',	'2024-07-09 05:32:27'),
...
(7,	'Stan Lee',	'lee@rhraju.com',	'+8801684530902',	NULL,	'engineer',	65000.00,	'2024-07-09 05:32:01',	'2024-07-09 05:32:01')
...
CREATE TABLE `subscriptions` (
  ...
  `status` enum('active','inactive','expired','restricted') CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci NOT NULL DEFAULT 'inactive',
...
(2,	9,	3,	'2024-04-24',	'2024-05-24',	'expired',	1050.00,	'2024-04-24 09:44:33',	'2024-07-07 08:52:01'),
(3,	7,	2,	'2024-05-24',	'2024-06-24',	'expired',	850.00,	'2024-05-24 13:08:56',	'2024-07-07 13:11:01'),
(4,	8,	4,	'2024-06-25',	'2024-07-25',	'active',	1150.00,	'2024-06-25 09:20:27',	'2024-07-07 09:06:29'),
(5,	2,	3,	'2024-06-25',	'2024-07-25',	'active',	1050.00,	'2024-06-25 14:03:28',	'2024-07-07 13:20:57'),
(6,	16,	4,	'2024-04-25',	'2024-05-25',	'expired',	1150.00,	'2024-05-25 14:40:30',	'2024-07-07 08:52:01'),
(7,	17,	3,	'2024-04-25',	'2024-05-25',	'expired',	1050.00,	'2024-05-25 14:40:30',	'2024-07-07 08:52:01'),
(9,	17,	3,	'2024-03-25',	'2024-04-25',	'expired',	1050.00,	'2024-03-25 14:40:30',	'2024-07-07 08:52:01'),
(10,	13,	3,	'2024-05-24',	'2024-06-24',	'expired',	1050.00,	'2024-05-24 09:44:33',	'2024-07-07 13:08:01'),
(11,	12,	3,	'2024-02-25',	'2024-03-25',	'expired',	1050.00,	'2024-02-25 14:03:28',	'2024-07-07 08:52:01'),
(12,	9,	3,	'2024-07-07',	'2024-08-06',	'active',	1050.00,	'2024-07-07 06:35:54',	'2024-07-07 13:23:14'),
(13,	7,	3,	'2024-07-07',	'2024-08-06',	'active',	1050.00,	'2024-07-07 15:18:58',	'2024-07-07 15:19:33'),
(14,	19,	2,	'2024-07-13',	'2024-08-12',	'active',	850.00,	'2024-07-13 04:22:33',	'2024-07-13 04:24:01')
...
(5,	7,	'TKT-0625-7-2505',	'General Enquiries',	'I would like to know more about your premium subscription plans. Could you please provide me with the details and pricing?',	NULL,	'closed',	'2024-06-25 09:07:21',	'2024-07-05 05:51:20'),
(6,	9,	'TKT-0625-9-7224',	'Filing a Complaint',	'I am dissatisfied with the recent service I received. The response time was very slow and did not resolve my issue.',	NULL,	'closed',	'2024-06-25 09:17:55',	'2024-07-05 05:51:06'),
...
(11,	9,	'TKT-0705-9-2951',	'Billing Issues',	'Are you able to renew the subscriptions after one month?',	NULL,	'closed',	'2024-07-05 05:49:20',	'2024-07-07 09:07:56'),
(12,	19,	'TKT-0713-19-7560',	'Billing Issues',	'How can I purchase the subscription?',	NULL,	'closed',	'2024-07-13 04:21:53',	'2024-07-13 04:25:12')
